...
const draw = () => {
    ...
    // 填充颜色
    ctx.fillStyle = `rgb(255, 255, 255) `; //randomColor(180, 230);
    // 填充的位置
    ...
    for (let i = 0; i < 4; i++) {
        ...
        imgCode += text;
        // 随机的字体大小
        const fontSize = 35; //randomNum(18, 40);
        // 字体随机的旋转角度
        ...
        ctx.fillStyle = `rgb(2, 2, 2)`; //randomColor(80, 150);
    ...
    for (let i = 0; i < 200; i++) {
        ...
        ctx.closePath();
        ctx.fillStyle = `rgb(161, 161, 161)`; //randomColor(150, 200);
        ctx.fill();
    }
    return imgCode;
};
